...
max_flank = 20
sequence_snvs_and_dels_max_flank = scarv_queries.query_sequence(training_loci_subsample_snvs_and_dels, max_flank, genome, reference_fasta)
scarv_queries.correct_refs(training_loci_subsample_snvs_and_dels, singleton_snvs, sequence_snvs_and_dels_max_flank)
...
sequence_ins_max_flank = scarv_queries.query_sequence(training_loci_subsample_insertions, max_flank, genome, reference_fasta)
training_loci_subsample_insertions.End -= 1
...
for flank in range(2, max_flank, 1):
    ...
    ival = scarv_diagnostics.IntervalEvaluation(validation_data=(X_val, y_val), flank=flank, patience=5, interval=1)
    ...
    auc_ht = scarv_diagnostics.hand_till_auc(preds, y_test)
