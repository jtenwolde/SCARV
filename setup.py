...
setup(
  ...
  description = 'Selective Constraint Against Rare Genetic SNVs',   # Give a short description about your library
  ...
  download_url = 'https://github.com/jtenwolde/SCARV/archive/refs/tags/v_02.tar.gz',    # I explain this later on
